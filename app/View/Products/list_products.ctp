			...
			?>
					...
					<?php } ?>
                                        ...
                                        <div class="product-universal-options">
												...
												<a href="<?php echo $this->Html->url('/edit/'.$product['Product']['id'], true); ?>">1) Editar</a>
												
												<?php  if($product['Image']){ ?>
													<a href="<?php echo $this->Html->url('/product/'.strtolower(Inflector::slug($product['Product']['title'])).'/'.$product['Product']['id'], true); ?>" >2) Ver</a>
												<?php }else{ ?>
													<a href="<?php echo $this->Html->url('/edit/'.$product['Product']['id'], true); ?>" >2) Ver</a>
												<?php } ?>
