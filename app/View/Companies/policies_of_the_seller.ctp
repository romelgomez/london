			...
			<div style="background: #424242; color: white; padding: 10px; margin-top: 10px; font-size: 17px;"> 
				<span>
					<div style="overflow: hidden;" >
						<div style="width: 100px; float: left;" >Politicas:</div> 
						<div style="float: right;" ><?php echo $company['Company']['name'].' '.$company['Company']['type'].' '.$company['Company']['rif']; ?></div>
					</div>
				</span> 
			</div>

			<h4 style="margin: 12px; margin-left: 5px;" >  <b>Ver tambien:</b>  <?php echo '<a href="/warranties_of_the_seller/'.strtolower(Inflector::slug($company['Company']['name'])).'/'.$company['Company']['id'].'">Garantias</a>'; ?></h4>
				<div style="border:1px solid #CCC; padding: 10px; background: #DBDBDB">
					<?php echo $company['Company']['policies']; ?><br>
				</div>
