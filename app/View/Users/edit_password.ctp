<div class="contenedor-b" style="padding: 10px;">
	...
	<div class="b-sobre"> 
		<div class="preguntas" >
			<h2 style="margin: 12px; margin-left: 5px;" >Editar clave:</h2>
				
					<?php 
						echo $this->Form->create('User',  array('url' => '/editPassword'));
								
							echo $this->Form->input('User.current_password',array('label'=>'Clave actual:','class'=>'input-basic','type'=>'password'));
							echo $this->Form->input('User.new_password',array('label'=>'Nueva clave:','class'=>'input-basic','type'=>'password'));
							echo $this->Form->input('User.new_password_repeated',array('label'=>'Repita la nueva clave:','class'=>'input-basic','type'=>'password'));
