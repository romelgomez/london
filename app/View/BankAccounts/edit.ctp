<div class="contenedor-b" style="padding: 10px;">
	...
	<div class="preguntas">
		...
		<?php 
			...
			echo $this->Form->create('BankAccount',  array('url' => '/editBankAccount/'.$id));
							
					echo '<h2>Edita un numero de cuenta</h2>';							
						
						echo $this->Form->input( 'BankAccount.id', array('type' => 'hidden','value'=>$id)); 
